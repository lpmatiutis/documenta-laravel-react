...
export default class AddTipoZona extends Component {
    ...
    handleSubmit = (e) => {
        ...
        console.log(this.state.newTipoZona);
    }
                ...
                <form onSubmit={this.handleSubmit}>
                    <div className="field">
                        ...
                        <div className="control">
                            <input className="input" type="text" onChange={(e) => this.handleInput('idtipozona', e)} />
                        </div>
                    ...
                    <div className="field">
                        ...
                        <div className="control">
                            <input class="input" type="text" onChange={(e) => this.handleInput('descripcion', e)} />
                        </div>
                    </div>
                    <div className="field">
                        <label className="label">Codigo: </label>
                        <div className="control">
                            <input class="input" type="text" onChange={(e) => this.handleInput('codigo', e)} />
                        </div>
                    </div>
