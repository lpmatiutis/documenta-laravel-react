            ...
            <div id="modal-div">
                <Modal size="lg" show={showModal} onHide={() => setModal(false)}>
                    ...
                    <Modal.Body id="pic-info">
                        <Image src={nasaData.hdurl} fluid></Image>
                        <h5 id="pic-sub-title">
                            {nasaData.copyright ? nasaData.copyright : "Desconocido" } | {nasaData.date}
                        </h5>
                        <p id="pic-summary"> <strong>Summary:</strong> {nasaData.explanation} </p>
                    </Modal.Body>
                    
                    <Button variant="danger" onClick= {() => setModal(false)} >Cerrar</Button>
                </Modal>
            </div>
        </>
    )
